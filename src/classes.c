/*
 * $Id: classes.c 732 2004-05-23 05:54:36Z skaar $
 *
...
/* 
 * Global class default variables for cfengine. These variables are what
 * needs to be modified if you add or modify class definitions...
 * remember also to change clsattr and search for the os types in
 * cfengine.c (mount stuff).
 */
 ...
 * If you change here change enum classes too! 
 */
char *g_classtext[] = {
    "",
    "<soft>",
...
char *g_classattributes[CF_CLASSATTR][CF_ATTRDIM] = {
...
char *g_vmountcomm[CF_CLASSATTR] = {
    "",                                              /* see cf.defs.h */
    "",
    "/etc/mount -va",      /* sun4 */
    "/etc/mount -va",      /* ultrix */
...
char *g_vunmountcomm[CF_CLASSATTR] = {
    "",                                              /* see cf.defs.h */
    "",
    "/etc/umount",      /* sun4 */
    "/etc/umount",      /* ultrix */
...
char *g_vmountopts[CF_CLASSATTR] = {
    "",                                              /* see cf.defs.h */
    "",
    "bg,hard,intr",    /* sun4 */
    "bg,hard,intr",    /* ultrix */
...
char *g_vresolvconf[CF_CLASSATTR] = {
    "-",
    "-",                                              /* see cf.defs.h */
